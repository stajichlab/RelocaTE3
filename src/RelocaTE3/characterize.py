"""Step 7: genotype non-reference insertions.

Supports both the table/BAM characterizer flow and the insertion-object helpers
used by the newer pipeline code.
"""
